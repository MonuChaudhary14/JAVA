...
//        The expression must be of type byte, short, char, int, String, enum, or their wrapper classes (Byte, Short, Character, Integer).
        switch (day/*expression*/) {
            case 1:    //Each case must have a unique value
            case 0:
            ...
            case 6:
                ...
                break;
            default:   //The default case is optional but executes if no case matches.
                System.out.println("Today is Saturday");
        }

        String result = switch(day) {

            case 1 , 2, 3 ,4, 5-> "WeekDay";     // No need to use break
            case 6 ,7-> "WeekEnd";           // It can return values
            default -> "Invalid day";
        ...
        int arr2[] = new int[10];  // We can also use this
        ...
        System.out.println(arr.length);  // arr.length is used to find the length of the array
