public class Ninth {
    ...
    derived from the object class. If a class does not extend any other class, then it is a direct child of Object class and
     ...
     */
      ...
      Models m = new Models("Honda" , 2024);
        ...
        Polymorphism allows us to perform a single action in different ways.
         ...
         1.Compile-time polymorphism --> In this two classes have same functions whose have same name and parameters so is decided in run-time.
         2.Runtime polymorphism --> In this there are two functions which have different parameters so it is decided on compile time
...
//        models = new Supercar();  // Find out the reason why it show erroe
//
